        ...
        <div className="flex flex-col items-center py-2">
          {canManage && isOccupied && !isMe && (
            <>
              ...
              <button onClick={() => onAction('kick-out')} className="w-full py-5 text-center font-black text-lg uppercase tracking-tight text-red-500 hover:bg-gray-50 active:bg-gray-100 transition-all border-b">Kick from Room</button>
              <button onClick={() => onAction('remove-from-seat')} className="w-full py-5 text-center font-black text-lg uppercase tracking-tight text-orange-500 hover:bg-gray-50 active:bg-gray-100 transition-all border-b">Remove from seat</button>
            </>
          )}
          {canManage && !isOccupied && (
            <>
              ...
              <button onClick={() => onAction('invite')} className="w-full py-5 text-center font-black text-lg uppercase tracking-tight text-blue-500 hover:bg-gray-50 active:bg-gray-100 transition-all border-b">Invite Friends</button>
            </>
          )}
