 ...
 * Mirrors the provided blueprint: Purple/Magenta glossy background,
 * 3D bright yellow bear icon, and golden "Seller" typography.
 */
  ...
  return (
    <div className={cn("relative inline-flex items-center justify-center select-none group", className)} style={{ transform: `scale(${scale})`, transformOrigin: 'left center' }}>
      ...
      <div className={cn(
        ...
        <div className="absolute inset-0 w-1/2 h-full bg-white/20 skew-x-[-30deg] -translate-x-[200%] animate-shine pointer-events-none" />
        
        {/* 3D Bright Yellow Bear Icon */}
        <div className="relative shrink-0 w-7 h-7 flex items-center justify-center drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)]">
           <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
              <defs>
                <linearGradient id="sellerBearGrad" x1="0%" y1="0%" x2="0%" y2="100%">
                  <stop offset="0%" stopColor="#fff176" />
                  <stop offset="100%" stopColor="#fbc02d" />
                </linearGradient>
                <linearGradient id="sellerEarGrad" x1="0%" y1="0%" x2="0%" y2="100%">
        ...
        {/* Seller Text with Gold Gradient */}
        ...
        <div className="absolute inset-0 pointer-events-none">
           <div className="absolute top-1 left-12 w-0.5 h-0.5 bg-white rounded-full animate-ping" />
           <div className="absolute bottom-1 right-6 w-1 h-1 bg-white/40 rounded-full animate-pulse" />
        </div>
      </div>
    </div>
  );
