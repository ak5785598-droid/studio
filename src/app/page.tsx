...
export default function Home() {
  ...
  useEffect(() => {
    if (!isLoading) {
      ...
      }, 2500); // Cinematic delay for splash impact
  ...
  return (
    <div className="flex h-screen w-full flex-col items-center justify-center bg-[#FFCC00] overflow-hidden relative font-headline">
      ...
      <div className="flex flex-col items-center gap-8 animate-in fade-in zoom-in duration-1000 slide-in-from-bottom-8 relative z-10">
        <div className="relative h-56 w-56 flex items-center justify-center group">
        ...
        <div className="flex flex-col items-center gap-2 mt-4 text-center">
           <h1 className="text-7xl font-black text-white italic tracking-tighter uppercase drop-shadow-lg animate-in fade-in slide-in-from-top-4 duration-700 delay-300">
             Ummy
           </h1>
